...
def get_args(params):
    ...
    parser.add_argument('-rsr', default="None", help='additional restraints')
    ...
    parser.add_argument('--permute', action='store_true', help='permute dimensions of 6D features when loading from npz')
